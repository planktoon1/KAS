...
public class TilmeldingDialog extends Stage {
	private final Controller controller = new Controller();

	/** Note: Tilmelding is nullable. */
	public TilmeldingDialog(String title, Tilmelding deltager) {
		controller.tilmelding = deltager;
	...
	private class Controller {
		...
		// if (Tilmelding != null) {
		// txfName.setText(Tilmelding.getName());
		// txfWage.setText("" + Tilmelding.getWage());
		// if (Tilmelding.getCompany() != null) {
		// cbxCompany.setSelected(true);
		// cbbCompany.getSelectionModel().select(Tilmelding.getCompany());
		...
		public void okAction() {
			...
			// Tilmelding deltager = new Tilmelding(txfNavn.getText().trim(), adresse);
